...
const dictionaries = {
  en: {
    ...
    exchangeField: 'Spatial exchange field',
    residue: 'Residue',
    memoryTrace: 'Memory',
    opticalTrace: 'Optical',
    role_real: 'Real',
    role_memory: 'Memory',
    role_hybrid: 'Hybrid',
...
const languagePacks = {
  ja: {
    ...
    metalness: '金属度', roughness: '粗さ', domainRouter: '数学ドメインルーター', exchangeField: '空間交換場', residue: '残留', memoryTrace: '記憶', opticalTrace: '屈折', role_real: '現実', role_memory: '記憶', role_hybrid: 'ハイブリッド', implicit: '陰関数幾何', phase: '相場発展',
  ...
  ko: {
    ...
    metalness: '금속도', roughness: '거칠기', domainRouter: '수학 도메인 라우터', exchangeField: '공간 교환장', residue: '잔류', memoryTrace: '기억', opticalTrace: '굴절', role_real: '현실', role_memory: '기억', role_hybrid: '하이브리드', implicit: '암시적 기하', phase: '상장 진화',
  ...
  es: {
    ...
    metalness: 'Metalicidad', roughness: 'Rugosidad', domainRouter: 'Enrutador matemático', exchangeField: 'Campo de intercambio espacial', residue: 'Residuo', memoryTrace: 'Memoria', opticalTrace: 'Óptica', role_real: 'Real', role_memory: 'Memoria', role_hybrid: 'Híbrido', implicit: 'Geometría implícita', phase: 'Evolución de fase',
  ...
  fr: {
    ...
    metalness: 'Métallicité', roughness: 'Rugosité', domainRouter: 'Routeur mathématique', exchangeField: 'Champ d’échange spatial', residue: 'Résidu', memoryTrace: 'Mémoire', opticalTrace: 'Optique', role_real: 'Réel', role_memory: 'Mémoire', role_hybrid: 'Hybride', implicit: 'Géométrie implicite', phase: 'Évolution de phase',
  ...
  de: {
    ...
    metalness: 'Metallizität', roughness: 'Rauheit', domainRouter: 'Mathematischer Router', exchangeField: 'Räumliches Austauschfeld', residue: 'Residuum', memoryTrace: 'Erinnerung', opticalTrace: 'Optik', role_real: 'Real', role_memory: 'Erinnerung', role_hybrid: 'Hybrid', implicit: 'Implizite Geometrie', phase: 'Phasenentwicklung',
  ...
  'pt-BR': {
    ...
    metalness: 'Metalicidade', roughness: 'Rugosidade', domainRouter: 'Roteador matemático', exchangeField: 'Campo de troca espacial', residue: 'Resíduo', memoryTrace: 'Memória', opticalTrace: 'Óptica', role_real: 'Real', role_memory: 'Memória', role_hybrid: 'Híbrido', implicit: 'Geometria implícita', phase: 'Evolução de fase',
